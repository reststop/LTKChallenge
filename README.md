...
- When a user taps on one of the full-width images, then a detail view should be pushed
onto the view stack. The detail view should contain product images, the hero image, and
the profile picture.
        - All of this information is returned from the API. To relate the different models
together (ltk, product, and profile), take a look at the JSON that is returned. There
are top-level lists for each of these. The ltk has a list of associated product_ids
and an associated profile_id.
...
### Alamofire - AF Networking for Swift 5.x

### AlamofireImage - Image caching and retrieval integrated with Alamofire


## Language - Swift 5


## BuildTools - Xcode Version 13.2.1 (13C100)
